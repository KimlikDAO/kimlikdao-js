...
const _9 = (() => { let r = new Uint8Array(32); r[0] = 9; return r })();
...
function crypto_sign_keypair(pk, sk, seeded) {
  ...
  if (!seeded) crypto.getRandomValues(sk);
  crypto_hash(d, sk, 32);
  d[0] &= 248;
  d[31] &= 127;
  d[31] |= 64;
 ...
 */
function checkArrayTypes(var_args) {
